...
<section class="content">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-header pt-3">
                        <div class="row invoice-info">
                            ...
                            @if (!empty($order->shipped_date))
                                {{ \Carbon\Carbon::parse($order->shipped_date)->format('y M, Y') }};
                            @else
                                N/A
                            @endif
                            </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    <form action="" method="" name="changeOrderStatusForm" id="changeOrderStatusForm">
                        <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post" class="sendInvoiceEmail" id="sendInvoiceEmail">
