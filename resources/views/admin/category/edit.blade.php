                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value={{ $category->slug }} readonly type="text" name="slug" id="slug" class="form-control" placeholder="Slug">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script>
    $("#categoryForm").submit(function(event) {
        ...
        // Ngăn chặn hành vi mặc định của sự kiện submit, tức là ngăn chặn trình duyệt tải lại trang.
        var element = $(this);
